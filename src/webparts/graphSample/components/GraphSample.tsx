...
import { IGraphSmapleState } from './IGraphSampleState';
...
export default class GraphSample extends React.Component<IGraphSampleProps, IGraphSmapleState> {

  constructor(props: IGraphSampleProps, state: IGraphSmapleState) {
    super(props);
        ...
        <div className={ styles.container }>
          <div className={ styles.row }>
            <div className={ styles.column }>
              <span className={ styles.title }>Search fro User!</span>
